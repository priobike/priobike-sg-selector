...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # define the search
        # Define grid search
        grid_search = GridSearchCV(estimator=MLPClassifier(max_iter=1000000),
        ...
        print(
            f'The best f1 score for the training dataset is {grid_result.best_score_:.8f}')
        # Print the hyperparameters for the best score
        print(f'The best hyperparameters are {grid_result.best_params_}')
        # Print the best f1 score for the testing dataset
        print(
            f'The f1 score for the testing dataset is {grid_search.score(X_test, y_test):.8f}')
