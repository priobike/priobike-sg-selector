...
class Command(BaseCommand):
    ...
    def search_best_configuration(self, hypermodel_cls, name: str):
        ...
        def objective(trial):
            ...
            train_size = int(train_proportion * number_of_routes)
            # Train dataset is the first 80% of the routes
            routes_with_bindings = routes_with_bindings[:train_size]
    ...
    def handle(self, *args, **options):
        ...
        strategies = {
            "topologic": TopologicHypermodelMatcher,
        }
